...
//        notesQuery.whereKey("NotesLowerCase", containsString: searchString.lowercaseString)
        ...
        bookPostQuery.orderByAscending(bookSortMain) // Order first by Title, alphabetically
        bookPostQuery.addAscendingOrder(bookSortSecondary) // Then order by Author, alphabetically
...
//            let alertController = UIAlertController(title: "Network Connectivity Issue", message: "Device must be connected to a network to work. Please connect to a network.", preferredStyle: .Alert)
//            
...
//                println("results empty -> no user settings")
//            }
//            
//            else {
//                var userSettingsArray = results as? [SettingsPost] ?? []
////                if results[0].BookSort == "Title" {
...
////                }
//                println("user settings array: \(userSettingsArray)")
...
//                println("settings don't exist")
            ...
            self.bookQueryFunction()
        }
        
//        println("userSettingsArray: \(userSettingsArray)")
...
//            }
//            
//            bookPostQuery.orderByAscending(bookSortMain) // Order first by Author, alphabetically
//            bookPostQuery.addAscendingOrder(bookSortSecondary) // Then order by Title, alphabetically
////            bookPostQuery.addAscendingOrder("Notes") // Then order by Notes, alphabetically
//            println("sorting by \(bookSortMain)")
//            
