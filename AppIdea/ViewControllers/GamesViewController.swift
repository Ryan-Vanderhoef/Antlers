...
class GamesViewController: UIViewController {
    ...
    var gameSortSecondary : String = "Title"
...
//        notesQuery.whereKey("NotesLowerCase", containsString: searchString.lowercaseString)
        ...
        gamePostQuery.orderByAscending(gameSortMain)     // Order first by Title, alphabetically
        gamePostQuery.addAscendingOrder(gameSortSecondary)  // Then order by Console, alphabetically
