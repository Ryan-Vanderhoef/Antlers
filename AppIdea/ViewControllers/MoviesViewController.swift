...
//        notesQuery.whereKey("NotesLowerCase", containsString: searchString.lowercaseString)
        ...
        moviePostQuery.orderByAscending(movieSortMain)    // Order first by Title, alphabetically
        moviePostQuery.addAscendingOrder(movieSortSecondary)    // Then order by Year, alphabetically
