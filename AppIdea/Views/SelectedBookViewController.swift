...
class SelectedBookViewController: UIViewController {
    ...
    @IBAction func shareButtonAction(sender: AnyObject) {
        ...
        let textToShare = "Check out \"\(titleTextField.text)\", a book by \(authorTextField.text)!\n\n'Antlers' allows you to store and organize your book, movie, and game libraries - Available on the App Store now"//"You should check out this book, \(titleTextField.text), by \(authorTextField.text)!\n\nCheck out Antlers - Available on the App Store now"
