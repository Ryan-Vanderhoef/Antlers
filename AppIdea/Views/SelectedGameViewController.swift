...
class SelectedGameViewController: UIViewController {
    ...
    @IBAction func shareButtonAction(sender: AnyObject) {
        ...
        let textToShare = "Check out \"\(titleTextField.text)\", a game on the \(consoleTextField.text)!\n\n'Antlers' allows you to store and organize your game, movie, and book libraries - Available on the App Store now"//"You should check out this game, \(titleTextField.text), on \(consoleTextField.text)!\n\nCheck out Antlers - Available on the App Store now"
